...
[Source: HackerRank Recursive Digit Sum](https://www.hackerrank.com/challenges/recursive-digit-sum/problem)
...
* `super_digit(9875)` $\rightarrow$ $9+8+7+5 = 29$ 
* `super_digit(29)` $\rightarrow$ $2 + 9 = 11$
* `super_digit(11)` $\rightarrow$ $1 + 1 = 2$
* `super_digit(2)` $\rightarrow$ $= 2$
